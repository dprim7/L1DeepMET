...
# Custom layers live in the library (l1deepmet.models.custom_layers) so
# src/ modules can use them without importing from scripts/. Re-exported
# here because ablation.py, evaluate.py, qat_validation.py and existing
# workflows import them from arch_search.
