...
def load_custom_objects() -> dict:
    ...
    Delegates to :func:`l1deepmet.models.serialization.get_custom_objects`;
    kept as a shim because existing drivers and tests import it from here.
    """
    from l1deepmet.models.serialization import get_custom_objects
